...
const benefits = {
  homeowners: [
    "Create one brief and receive multiple structured agent offers in 24-48h.",
    "Compare fees, inclusions, timelines and terms side-by-side.",
    "Shortlist and award before chat opens."
  ],
  agents: [
    "Compete on service scope and pricing with a standard proposal format.",
    "Browse LIVE instructions with seller goals and timelines.",
    "Chat opens after shortlist/award to keep leads focused."
  ]
} as const;
      ...
      <div className="mx-auto w-full max-w-5xl space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-3xl text-text-muted">
            We keep sign-up simple: continue with Google, then choose whether you are joining as a Homeowner or an Agent in the next step.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card className="space-y-4">
            <h2 className="text-xl">For Agents</h2>
            <ul className="space-y-2 text-sm text-text-muted">
        ...
        <Card className="mx-auto w-full max-w-xl space-y-4 text-center">
          <div className="space-y-1">
            ...
            <p className="text-sm text-text-muted">You will choose Homeowner or Agent after sign-in.</p>
          </div>
