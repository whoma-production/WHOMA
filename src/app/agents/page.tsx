      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="space-y-3">
          ...
          <p className="max-w-3xl text-sm text-text-muted sm:text-base">
            This directory only shows profiles that are both published and admin verified. It is the public proof layer
            for WHOMA&apos;s Phase 1 identity pilot.
          </p>
        </div>

        <Card className="mt-6 space-y-3 bg-surface-0">
          <p className="text-sm text-text-muted">
            Looking for homeowner tendering? It remains a secondary pilot path while WHOMA validates verified agent
            depth first.
          </p>
        ...
        <form className="mt-6 grid gap-3 rounded-md border border-line bg-surface-0 p-4 md:grid-cols-3">
          <label className="space-y-1 md:col-span-1">
            <span className="text-xs font-semibold uppercase tracking-[0.12em] text-text-muted">Service area</span>
          ...
          <label className="space-y-1 md:col-span-2">
            ...
            <Input name="specialty" defaultValue={specialty ?? ""} placeholder="Family homes" />
          </label>
        ...
        {agents.length === 0 ? (
          <Card className="mt-6 space-y-3">
            ...
            <p className="text-sm text-text-muted">
              Try a wider area search, or start your own profile so you can move through verification and public launch.
            </p>
